...
<body>
    ...
    <form method="post">
        {{csrf_field()}}
        <h3 align="center"> Reply SMS</h3><br/>
        <table class="abs"   width="60%" align="center">
            <tr>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Room Name:</td>
                <td>&nbsp;&nbsp;&nbsp;<input type="text" readonly value="{{$data['room']}}" name="name"></td>
            </tr>
            <tr> <td> &nbsp; </td> </tr>
            <tr>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To:</td>
                <td>&nbsp;&nbsp;&nbsp;<input type="text" readonly value="{{$data['sender']}}" name="reciever">
                </td>
            </tr>
            <tr> <td> &nbsp; </td> </tr>
            <tr>
